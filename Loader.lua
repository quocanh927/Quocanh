--[[ 
    SYSTEM BY QuocAnh ROBLOX 
    LINK GET KEY: https://fnote.net/notes/ARn7q5
    KEY: QuocAnhVIP
]]
...
ScreenGui.Name = "QuocAnhMenu_System"
...
local fileName = "QuocAnhMenu_SavedKey.txt"
local correctKey = "QuocAnhVIP"
...
CopyBtn.MouseButton1Click:Connect(function()
    if setclipboard then
        setclipboard("https://fnote.net/notes/ARn7q5")
    end
